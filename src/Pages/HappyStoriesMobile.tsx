    ...
    return (
        <div ref={ref} className="container  overflow-hidden ">
            ...
            {/* <div>
                    ...
                    <div className=" flex flex-col justify-center items-center space-y-10 max-lg:space-y-5 max-lg:mt-10 max-sm:mt-8 max-sm:space-y-4">
                        ...
                        <div>
                            ...
                            <button
                                ...
                                className="flex items-center gap-3 bg-gradient py-3 px-8 text-white text-lg font-medium shadow-redboxshadow rounded-md group max-lg:px-6"
                            >
                ...
                >
                    <div
                        className="relative mx-auto w-[770px] pt-[140px] pb-[70px] max-lg:pt-24 max-lg:pb-14 max-lg:w-[700px] max-md:w-[95%] max-md:pt-18 max-md:pb-10 max-sm:px-0 max-sm:py-12"
                    >
                        <iframe
                            width={"100%"}
                            height={500}
