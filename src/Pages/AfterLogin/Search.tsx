...
const Search = () => {
  ...
  // You can use this to clear old data when the user visits the search page
  useEffect(() => {
    if (context) {
  ...
  return (
    <div className="bg-grayBg">
      {/* This component now only renders the form.
        No more conditional rendering or state for results.
      */}
      <AdvancedSearch onFindMatch={function (): void {
        throw new Error("Function not implemented.");
      } } handle_Get_advance_search={function (): void {
        throw new Error("Function not implemented.");
      } } />
    </div>
  );
