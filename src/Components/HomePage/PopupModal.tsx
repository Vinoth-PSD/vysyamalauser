...
// //             <h2 className="text-primary text-2xl font-semibold mb-4 text-center max-md:text-[20px]">OTP Verificatioan</h2>
...
// //               <p className="text-primary text-lg max-md:text-base">
// //                 Didn&apos;t receive OTP?{" "}
// //                 <span className="text-main font-semibold cursor-pointer max-md:font-semibold">Resend OTP</span>
// //               </p>
// //             </div>
...
//   // const [mobileNumberr,setMobileNumber]=useState<string>('')
...
//             <p className="text-primary text-lg mb-6 text-center">We have sent a verification code to<br />
