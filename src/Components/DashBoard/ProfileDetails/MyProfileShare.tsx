...
//             <WhatsappShareButton
//               url={shareUrl} // Dynamic URL with proper OG tags
...
export const MyProfileShare: React.FC<ShareProps> = ({
  ...
  // Dynamic URL to the profile share page
 // const shareUrl = `http://matrimonyapp.rainyseasun.com/ProfileImage?data=${encodedData}`;
 const shareUrl = `https://matrimonyapi.rainyseasun.com/auth/profile/${profileId}/`;
 const shareUrlWithoutImage=`https://matrimonyapi.rainyseasun.com/auth/profile_view/${profileId}/`
  const title = 'Check out this profile!';
const registrationLink = 'http://matrimonyapp.rainyseasun.com/'
