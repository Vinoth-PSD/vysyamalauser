          ...
          {[
            ...
            >
              {amsamContents[index].map((label, labelIndex) => (
                <div
                  key={labelIndex}
                  className="w-24 h-auto mx-auto relative bg-white text-[9px] px-1 py-1 my-1 rounded text-center flex items-center justify-between max-2xl:w-[80px] max-sm:w-[90%]"
                >
                  {label}
                  {/* <AiOutlineClose
